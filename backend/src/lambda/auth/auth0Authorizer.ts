...
// const jwksUrl = 'https://dev-83e5hp-6.us.auth0.com/.well-known/jwks.json'
...
//     if (!key) {
//       throw new Error(`No signing key matching '${kid}' was found`);
//     }
...
if (!signingKey){
throw new Error(`unable to find signing key ${jwtKid}`);
}
